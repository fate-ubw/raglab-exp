...
def get_config():
    ...
    parser.add_argument('--realtime_retrieval', action='store_true', help='rag lab can use llm inference without retrieval') # 可以更方便的对比实验
...
if __name__=='__main__':
    ...
    # 但是这样就意味着需要统一所有的函数的 return 目前这样做肯定是有问题的，最关键的是后续还需要实现chat.py 所以每一个函数的 reterun 都要返回，
