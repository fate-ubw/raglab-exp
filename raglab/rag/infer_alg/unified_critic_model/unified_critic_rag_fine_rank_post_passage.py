...
class UnifiedCriticRAGFineRankPostPassage(SelfRag_Reproduction):
    ...
    def infer(self, query):
        ...
        for p_idx, passage in passages.items():
            ...
            basemodel_instruction = self.find_algorithm_instruction('base_model_instruction-post_passage',None)
