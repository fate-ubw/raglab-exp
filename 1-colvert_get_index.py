...
if __name__=='__main__':
    ...
    with Run().context(RunConfig(nranks=8, experiment='/home/zxw/raglab-exp/data/retrieval/colbert_test')):  # nranks specifies the number of GPUs to use.
    ...
    pu.db
    with Run().context(RunConfig(experiment='/home/zxw/raglab-exp/data/retrieval/colbert_test')):
