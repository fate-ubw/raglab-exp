...
# Read the JSONL file
import pudb
input_file_path = '/home/wyd/raglab-exp/1-eval_output/infer_output-asqa_eval_gtr_top100-selfrag_llama2_7b-0229_1006.jsonl'  # Replace with your file path
output_file_path = '/home/wyd/raglab-exp/1-eval_output/infer_output-asqa_eval_gtr_top100-selfrag_llama2_7b-0229_1006-ALCE.jsonl'  # Replace with your desired output file path
